 ...
 * \sa doCircleSelect()
 */
void Selection::doSelect(Drawable *node, unsigned type, float x, float y, float w, float h)
{
	GLint hits;
 ...
 * \sa doSelect()
 */
void Selection::doCircleSelect(Drawable *node, unsigned type, int xc, int yc, int r)
{
	int x0 = xc - r;
	int y0 = yc - r;
	int x1 = xc + r;
